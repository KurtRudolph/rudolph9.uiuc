		...
		\begin{column}{\sepwid}\end{column}			% empty spacer column
			...
			\begin{column}{\twocolwid}
				\begin{alertblock}{Abstract}
					\rmfamily{
						Benchmarks for HPC systems generally focus on floating-point intensive calculations. Few of these address data intensive graph operations, a class of computation greatly growing in demand. As an alternative to the standard floating-point benchmarks a new benchmark, the Graph 500, has been proposed. The focus of this project is exploring additional implementations of the Graph500 benchmark. Specifically the project is looking at the UPC programming model, a partitioned global address space language that extends C.
					}
				\end{alertblock}
